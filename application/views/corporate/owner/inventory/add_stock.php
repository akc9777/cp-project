            ...
            <form class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input id="" name="provider" type="text" placeholder="Provider"
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input id="" name="bill_no" type="text"
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <input id="" name="item_stock" type="text" placeholder="Addition stock (in cu.ft/pc)"
                                   class="form-control input-md">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-6 control-label"></label>
                        <div class="col-md-6">
                            <button onclick="validate()" name="add" class="btn btn-primary">Add Stock</button>
                        </div>
                    </div>
