    ...
    <table class="table">
        ...
        foreach ($details as $item): ?>
            <tr>
                ...
                <td><a class="btn btn-primary" href="task_detail/<?php echo $item->bill_no; ?>">View</a></td>
                <td><a onclick="validate()" class="btn btn-success"
                       href="mark_as_delivered/<?php echo $item->bill_no; ?>">Mark as delivered</a></td>
